...
if ( ! defined( 'ABSPATH' ) ) { exit; }
  ...
  class ImportExport {
    ...
    public function create_endpoint(){
        register_rest_route('hydra-booking/v1', '/settings/import-export', array(
            'methods' => 'GET',
            'callback' => array($this, 'GetImportExportData'),
            // 'permission_callback' =>  array(new RouteController() , 'permission_callback'),
        )); 
        register_rest_route('hydra-booking/v1', '/settings/import-export/export-meeting-csv', array(
            'methods' => 'POST',
            'callback' => array($this, 'ExportMeeting'),
            // 'permission_callback' =>  array(new RouteController() , 'permission_callback'),
        )); 

        register_rest_route('hydra-booking/v1', '/import-export/import-meeting', array(
            'methods' => 'POST',
            'callback' => array($this, 'ImportMeeting'),
            // 'permission_callback' =>  array(new RouteController() , 'permission_callback'),
        )); 
        // Import Booking 
        register_rest_route('hydra-booking/v1', '/settings/import-export/import-booking', array(
            'methods' => 'POST',
