...
if ( ! defined( 'ABSPATH' ) ) { exit; }
  ...
  class AvailabilityController {
    ...
    public function create_endpoint(){
        register_rest_route('hydra-booking/v1', '/availability', array(
            'methods' => 'GET',
            'callback' => array($this, 'get_all'),
            // 'permission_callback' =>  array($this, 'permission_callback'),
        ));
        register_rest_route('hydra-booking/v1', '/availability/(?P<id>[0-9]+)/', array(
            'methods' => 'GET',
        ...
        register_rest_route('hydra-booking/v1', '/availability/update/', array(
            'methods' => 'POST',
            'callback' => array($this, 'update'),
            // 'permission_callback' =>  array($this, 'permission_callback'),
        )); 
        register_rest_route('hydra-booking/v1', '/availability/delete/(?P<id>[0-9]+)/', array(
            'methods' => 'GET',
