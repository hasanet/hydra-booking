...
(function($) {	
    $(document).ready(function(){
        ...
        $('.wpcf7-form').each(function(){
            ...
            var date_id = $this.find('.hydra-form-input-date').attr('id');
            var date_data = $this.find('.hydra-form-input-date').attr('date-data');
            date_data = JSON.parse(date_data);  

            // Check if date is enable
            if(date_data.hydra_enable == true){

                // Get time id and time data
                var time_id = $this.find('.hydra-form-input-time').attr('id');
                var time_data = $this.find('.hydra-form-input-time').attr('time-data');
                ...
                if(date_data.hydra_allowed_date == 'range'){
                ...
                }else if (date_data.hydra_allowed_date == 'specific') { 
        ...
        function day_base_timepicker($this, dateStr, store_data, time_data, time_id){ 
            ...
            if(time_data.hydra_allowed_time == 'day'){
            ...
            }else if(time_data.hydra_allowed_time == 'specific'){
            ...
            // Initiate time in Contact form 7
            $('#'+time_id).parent().find('.hydra-time-picker').remove();
