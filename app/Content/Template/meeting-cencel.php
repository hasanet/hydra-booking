            ...
            <div class="tfhb-meeting-confirmation">  
                ...
                <?php if($booking->status == 'cancelled'): ?>
                    <div class="tfhb-notice notice-error" > 
                        <span><?php echo esc_html('This meeting has been cancelled by the ') . $booking->cancelled_by . '.' ?></span>
                    </div>
                <?php else: ?>
                <div class="hidden-field"> 
                    <input type="hidden" id="booking_hash" name="booking_hash" value="<?php echo $booking->hash; ?>"> 
                </div> 
